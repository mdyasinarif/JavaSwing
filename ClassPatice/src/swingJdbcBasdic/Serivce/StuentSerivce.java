...
public class StuentSerivce implements CommonDAO {
    ...
    public void save(Student obj) {
        ...
        try {
            ...
            Logger.getLogger(StuentSerivce.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void deleteById(int id) {
        ...
        try {
            ...
            ps.setInt(1, id);
            ps.executeUpdate();
            System.out.println("Daleate Success");
