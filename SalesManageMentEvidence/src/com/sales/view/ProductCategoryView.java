...
public class ProductCategoryView extends javax.swing.JFrame {
    ...
    public void displayRoleListIntoTable() {
        ...
        List<ProductCatagory> list = catDao.getList();
        DefaultTableModel model = (DefaultTableModel) tblDisplay.getModel();
        Object[] col = new Object[2];

        for (int i = 0; i < list.size(); i++) {
            col[0] = list.get(i).getId();
            col[1] = list.get(i).getCatName();
            model.addRow(col);
        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ProductCatagory cat = new ProductCatagory(catName);
            obj.save(cat);
            displayRoleListIntoTable();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        String catName = txtCatName.getText();
        ProductCatagory pc = new ProductCatagory(catId, catName);
        dao.update(pc);
        displayRoleListIntoTable();
    ...
    private void tblDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDisplayMouseClicked
        ...
        DefaultTableModel model = (DefaultTableModel) tblDisplay.getModel();
        catId = Integer.parseInt(model.getValueAt(i, 0).toString());
